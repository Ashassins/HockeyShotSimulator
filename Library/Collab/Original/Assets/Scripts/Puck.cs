...
{
    [SerializeField] private GameObject postScoreData;
    ...
    public void reset_puck() {
        ...
        curr_name = name[i];
        transform.position = new Vector3((float) (-28.57 + (57.67 * x[i])),-0.239f, (float)(-16.64 + (35.64 * y[i])));
        transform.rotation = Quaternion.Euler(0,0,0);
        rb.velocity = new Vector3(0,0,0);
        
    }

    public void displayData(Puck puck) {
